...
#DF <- read.csv("G:/R/finalexp/big/kmeans/10/csv/tdm.csv")
...
write.csv(m,"G:/R/finalexp/big/kmeans/10/finalresults.csv")
...
for(z in 1:people){
  ...
  path <- paste("G:/R/finalexp/big/kmeans/10/plots/behavior/",myFile,sep = "")
...
for(z in 1:people){
  ...
  myFile <- paste(z,".png",sep = "")
  path <- paste("G:/R/finalexp/big/kmeans/10/plots/distance/",myFile,sep = "")
